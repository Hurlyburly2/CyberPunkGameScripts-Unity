    ...
    private void SetChipProperties()
    {
        switch(itemName)
        {
            case "Cheap Ghost":
                ...
                itemAbilityDescription = "Your first two 2-Connection spikes each hack are worth +1.";
            ...
            case "JuryRigged QwikThink":
                ...
                itemAbilityDescription = "Your first 3-Connection spike is worth double the points.";
            ...
            case "Salvaged Router":
                ...
                itemAbilityDescription = "Each Hack: The first time you place a card outside the safe zone, it does not raise the security level.";
